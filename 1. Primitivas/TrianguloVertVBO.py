...
# Variables globales
VBOVert = None # Vertex Buffer Object
programaID = None
...
def init():
    ...
    # Se genera un código para el buffer de vértices
    VBOVert = glGenBuffers(1) 

    # Se asigna un código al buffer
...
def display():
    ...
    # Se utiliza el ARRAY_BUFFER
    glBindBuffer(GL_ARRAY_BUFFER, VBOVert)

    # Se habilita el arreglo de los vértices (indice = 0)
    glEnableVertexAttribArray(0)
    
    # Se envia el arreglo de vértices al buffer de la GPU
    ...
    # Se deja de utilizar el ARRAY_BUFFER
    glBindBuffer(GL_ARRAY_BUFFER, 0)
